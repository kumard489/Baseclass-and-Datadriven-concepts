...
public class BaseClass {
	...
	// 49
	public static void selectingDropdownIndex(String elementXpath, int index) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
		slct.selectByIndex(index);
	}

	// 50
	public static void selectingDropdownText(String elementXpath, String visibleTxt) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 51
	public static void selectingDropdownValue(String elementXpath, String value) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 52
	public static void deselectingDropdownIndex(String elementXpath, int index) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
		slct.selectByIndex(index);
	}
	...
	// 53
	public static void deselectingDropdownText(String elementXpath, String visibleTxt) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
		slct.selectByVisibleText(visibleTxt);
	}
	...
	// 54
	public static void deselectingDropdownValue(String elementXpath, String value) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
		slct.selectByValue(value);
	}
	...
	// 55
	public static void isMultiSelectDropdown(String elementXpath) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 56
	public static void getOptionsInDropdown(String elementXpath) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 57
	public static void getAllSelectedOptionsInDropdown(String elementXpath) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 58
	public static void get1stSelectedOptionInDropdown(String elementXpath) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
	...
	// 59
	public static void deselectAllInDropdown(String elementXpath) {
		WebElement drpDwn = driver.findElement(By.xpath(elementXpath));
		slct = new Select(drpDwn);
		slct.deselectAll();
	}
